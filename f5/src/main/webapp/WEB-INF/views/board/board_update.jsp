	            	...
	            	<div class="board-write-container">
	            		...
	            		<input type="hidden" name="boardIdx" value="${vo.boardIdx}">
		            		<table class="write-table">
		            			...
		            			<tr>
		            				<td colspan="2"><input name="boardTitle" type="text" placeholder="제목을 입력해주세요" class="title" value="${vo.boardTitle}"></td>
		            			</tr>
		            			<tr><th colspan="2"><label class="label">내용</label></th></tr>
		            			<tr>
		            				<td colspan="2"><textarea name="boardContent" class="content" placeholder="내용을 입력해주세요">${vo.boardContent}</textarea></td>
		            			</tr>
            	...
            	<div class="board-write-btn-container">
            		<div class="board-write-btn-container-wrap">
						<button id="update_btn" class="cusbtn" type="button">수정완료</button>	            		
	   					...
	   					<a href="boardContent.do?boardIdx=${vo.boardIdx}">

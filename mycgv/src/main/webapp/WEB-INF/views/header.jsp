...
<header>
		<div>
			...
			<div>
				<a href="http://localhost:9000/mycgv/index.do"><img src="http://localhost:9000/mycgv/resources/images/h1_cgv.png"></a>
				<div>
					<img src="http://localhost:9000/mycgv/resources/images/h2_cultureplex.png">
					<nav>
						<ul>
							<li><a href="#">영화</a></li>
							<li><a href="#">예매</a></li>
